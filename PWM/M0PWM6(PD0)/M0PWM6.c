/*
 * M0PWM6.c
 * Use M0PWM6/PD0 to generate pulse-width modulated outputs.
 * ----------
 ...
 * Discription: Initialize M0PWM6/PD0.
 */
void M0PWM6_Init(uint16_t period, uint16_t duty){
    ...
    GPIO_PORTD_PCTL_R |= GPIO_PCTL_PD0_M0PWM6;             // configure PD0 as M0PWM6
    ...
    PWM0_3_GENA_R |= PWM_3_GENA_ACTLOAD_ZERO;              // PD0 goes low on LOAD
    PWM0_3_GENA_R |= PWM_3_GENA_ACTCMPAD_ONE;              // PD0 goes high on CMPA down
