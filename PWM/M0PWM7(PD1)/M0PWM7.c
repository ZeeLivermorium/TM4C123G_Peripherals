/*
 * M0PWM7.c
 * Use M0PWM7/PD1 to generate pulse-width modulated outputs.
 * ----------
 ...
 * Discription: Initialize M0PWM7/PD1.
 */
void M0PWM7_Init(uint16_t period, uint16_t duty){
    ...
    GPIO_PORTD_PCTL_R |= GPIO_PCTL_PD1_M0PWM7;             // configure PD1 as M0PWM7
    ...
    PWM0_3_GENB_R |= PWM_3_GENB_ACTLOAD_ZERO;              // PD1 goes low on LOAD
    PWM0_3_GENB_R |= PWM_3_GENB_ACTCMPBD_ONE;              // PD1 goes high on CMPB down
